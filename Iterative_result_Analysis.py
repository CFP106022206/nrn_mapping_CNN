...
second_stage_result = './Iterative_result/Second_stage_Result_' + model_name
final_stage_result = './Iterative_result/Final_stage_Result_' + model_name
...
# %% 将数据组合成一个列表
Precision_set = [Precisions_second_stage, Precisions_final_stage]
Recall_set = [Recalls_second_stage, Recalls_final_stage]
F1_pos_set = [F1_pos_second_stage, F1_pos_final_stage]


# 创建标签
labels = ['Second Stage', 'Final Stage']
...
def generate_violinplot(data_set, y_label):
    ...
    plt.savefig('./Iterative_Figure/3_stage_'+y_label+'_violin.png', dpi=300, bbox_inches="tight")
    # 显示图像
    plt.show()
...
conf_average_second_stage = average_conf_matrix(conf_matrixs_second_stage)
conf_average_final_stage = average_conf_matrix(conf_matrixs_final_stage)
...
def generate_cross_loss_curve(losses_df, curve_color, name):
    ...
    plt.savefig('./Iterative_Figure/Loss_Curve_'+name+'.png', dpi=300, bbox_inches="tight")
    plt.show()



# Second Stage
second_history_path = './Iterative_result/Train_History_Second_stage_' + model_name
...
# Final Stage
final_history_path = './Iterative_result/Train_History_Final_' + model_name
