...
threshold_in = np.cos(np.pi*50/180)#np.cos(np.pi*90/180)  # threshold of inner product
threshold_of_distance = 100#np.inf  # threshold of distance between wrapping EM data and FC data
