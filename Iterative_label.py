...
# load train, test
label_table_train = pd.read_csv('./train_test_split/train_split_' + str(num_splits) +'_D1-' + data_range + '.csv')
label_table_test = pd.read_csv('./train_test_split/test_split_' + str(num_splits) +'_D1-' + data_range + '.csv')
