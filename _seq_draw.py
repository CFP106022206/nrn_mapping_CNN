...
# Primary params
FILE_PATH = "data/selected_data/test_0to20.csv" # CSV to read and run, with full path from the root folder
NEW_DIR = 'three_view_pic_rk0to20/' # !!! Save pkls in 'statistical_results/' + NEW_DIR. Need to add '/' at the end
