...
NEW_DIR = 'three_view_pic_paper_RSN/' # !!! Save pkls in 'statistical_results/' + NEW_DIR. Need to add '/' at the end
W_KEY = 'rsn' # Weighting keys: unit, sn, rsn. Choose ONE for per run
